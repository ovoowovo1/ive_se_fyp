...
public class FragmentForYou extends Fragment {
    ...
    public void loadData(DonateItemAdapter adapter){
        ...
        Call<List<DonateItem>> call = service.getDonateItems(authToken , userId);
        call.enqueue(new Callback<List<DonateItem>>() {
            ...
            public void onResponse(Call<List<DonateItem>> call, Response<List<DonateItem>> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.d("ForYou", "Failed to load data: " + response.message());
                }
            }

            @Override
            public void onFailure(Call<List<DonateItem>> call, Throwable t) {
                Log.d("ForYou", "onFailure Failed to load data: " + t.getMessage());
            }
        });
    ...
    public interface DonateDataApiService {
        @GET("usergetrecommendationresult/{userID}")
        Call<List<DonateItem>> getDonateItems(@Header("Authorization") String token, @Path("userID") String userId);
    ...
    public void showToast(String message){
        if(getContext() != null) {
            ...
            Log.e("ForYou", "Context is null, cannot show toast");
        }
    }
