...
public class MeRequestFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        preferenceManager = new PreferenceManager(getContext()); // Initialize the PreferenceManager
        initializeRetrofit();
    }
    ...
    public interface RequestApi {
        @GET("api/me-user-requests") // Update this to your correct API endpoint
        Call<List<UserRequest>> getUserRequests(@Query("userID") String userID);
    }

    private void loadUserRequests(RequestApi api,String userID) {
        api.getUserRequests(userID).enqueue(new Callback<List<UserRequest>>() {
            @Override
