...
text_violation_blueprint = Blueprint('azure_text', __name__)

@text_violation_blueprint.route('/azure_text', methods=['POST']) 
def analyze_text():
    print("analyze_text")
    data = request.json
    print(data)
...
if __name__ == "__main__":
    ...
    content = "You are nigg black fuck you bitch sb"
