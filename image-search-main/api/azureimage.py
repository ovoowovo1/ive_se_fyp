...
endpoint = "https://textdection2.cognitiveservices.azure.com/"
subscription_key = "YOUR_AZURE_COGNITIVE_SERVICES_KEY"
api_version = "2023-10-01"
content_safety = ContentSafety(endpoint, subscription_key, api_version)

image_violation_blueprint = Blueprint('azure_image', __name__)

@image_violation_blueprint.route('/azure_image', methods=['POST']) 
def analyze_image():
    print("analyze_image")  
    data = request.json
    ...
    #image_path = 'D:/programme/fyp-python/testing/123.png'
